<template>
		<div>
				<div id="bbb" style="width: 100%;height:250px;"></div>
		</div>
</template>
...
export default{
    ...
    setIntervalOfRealTime () {
            ...
            uthis.timeerOfRealtime = setInterval(() => {
                ...
                fetch("http://172.16.15.193:8069/sz/json?model=zabbix_item_data&name=itemid&name2=clock&name3=value&limit=10&f_itemid=32338",{
                            method:'get'
                ...
                fetch("http://172.16.15.193:8069/sz/json?model=zabbix_item_data&name=itemid&name2=clock&name3=value&limit=10&f_itemid=32340",{
                    method:'get'
                }).then(function(respones){
                    return respones.json()
                }).then(function(data){
    ...
    mounted(){
        this.realTimeInvokeChart = echarts.init(document.getElementById('bbb'),'blue-science');
